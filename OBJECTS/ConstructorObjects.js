...
// obj1 = {"full-name" : "karan" , "age" : 19},
// obj2 = {"full-name" : "karan" , "age" : 19}
// console.log(obj1 , obj2); //TODO , BOTH HAVE SAME VALUES BUT NOT SAME REFERENCE MEANS EACH WILL CREATE A NEW OBJECT SO BOTH WILL CREATE DIFFERENT MEMORY LOCATIONS  

// obj1 = {"full-name" : "karan" , "age" : 19};
// let obj2 = obj1; //! NOW OBJECT2 IS A SHALLOW COPY(SAME REFERNCE)
// console.log((obj1 === obj2)); //?TRUE 
// console.log(obj1 , obj2);

let obj1 = {"full-name" : "karan" , "age" : 19};
let obj2 = {"full-name" : "karan" , "age" : 19};

let arr = [obj1 , obj2]
console.log(arr[0]); //!PRINTS IT SINGLE TIME ..
